...
@RestController
@RequestMapping("/api/jhmkapp-kafka")
public class JhmkappKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhmkappKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhmkappKafkaResource(KafkaProperties kafkaProperties) {
